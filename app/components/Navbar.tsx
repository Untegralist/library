              ...
              {isAdmin && (
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10.362 1.093a.75.75 0 0 0-.724 0L2.523 5.018 10 9.143l7.477-4.125-7.115-3.925ZM1.25 5.75v6.5a.75.75 0 0 0 .375.65l7.75 4.5a.75.75 0 0 0 .75 0l7.75-4.5a.75.75 0 0 0 .375-.65v-6.5l-7.639 4.215a.75.75 0 0 1-.722 0L1.25 5.75Z"
                      clipRule="evenodd"
                    />
                  </svg>
        ...
        <div className="md:hidden bg-white border-t border-gray-100 shadow-lg max-h-[90vh] overflow-y-auto">
          <div className="px-4 pt-4 pb-6 space-y-3">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <MobileNavLink href="/authors" onClick={() => setIsMobileMenuOpen(false)}>
                Authors
              </MobileNavLink>
